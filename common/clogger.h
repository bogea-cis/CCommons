...
const char CLOGGER_BAK_EXTENSION[] = "log";
...
class CLogger 
{
	public:
		...
		virtual void logHex(const char* fileName, const char* functionName, LOG_PRIORITY priority, int lineNum, const char* asciiHeader, const unsigned char* hexMessage, unsigned int len);
		virtual void logEsc(const char* fileName, const char* functionName, LOG_PRIORITY priority, int line, const char* asciiHeader, const unsigned char* hexMessage, unsigned int len);
		...
		virtual bool checkPriority(LOG_PRIORITY priority);
	...
	protected:
		...
		// virtual bool isDuplicate(const char* fileName, const char* functionName, const char* format, va_list args);
